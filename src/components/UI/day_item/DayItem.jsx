...
const DayItem = (props) => {
    ...
    useEffect(() => {
        console.log(`Day ${props.day.day_number} is active = ${props.day.is_current}`)
    }, []);
    return (
        <div>
            {
                props.day.is_current ?
                    <div onClick={(e) => router(`/day/${props.day.day_date}`)} className={cl.main_container_selected}>
